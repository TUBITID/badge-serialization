...
import { lib, LibWordArray } from 'crypto-js';
...
export class BinaryFormatter {
    ...
    public stringify = (cipherParams: any): Uint8Array => {
    ...
    public parse = (arr: Uint8Array): any => {
        const params: ICipherParamType = {};
        let offset = 0;
